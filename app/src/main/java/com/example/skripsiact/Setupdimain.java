...
public class Setupdimain extends AppCompatActivity {
    ...
    private CircleImageView ProfilPic1 , EditProfilePic1;
    private FirebaseUser user;
    private FirebaseAuth auth;
    private Bitmap bitmap;
    private Button UpProfPic1;
    Uri filePath = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setupdimain);
        ProfilPic1 = (CircleImageView) findViewById(R.id.setup_image1);
        ...
        UpProfPic1 = findViewById(R.id.setup_btn1);
        reference = database.getReference("User");
        EditProfilePic1 = findViewById(R.id.addpic1);


        EditProfilePic1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        UpProfPic1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void UploadImageInStorageDataBase() {
        ...
        if (filePath  != null){
            ...
            progressDialog = new ProgressDialog(Setupdimain.this);
            ...
            FilePath.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Setupdimain.this, "Profil Pic Uploaded", Toast.LENGTH_SHORT).show();
                            ...
                            FilePath.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Glide.with(Setupdimain.this)
                                            .load(ProfilPic_url);
                                    reference.child("Profil_Pic").setValue(ProfilPic_url);
                                    Intent finishprof = new Intent (Setupdimain.this , MainMenu.class);
                                    finish();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Setupdimain.this, "File Upload Fail!" + e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
    ...
    private void Choose_Profile() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Setupdimain.this);
        ...
        if (resultCode == Activity.RESULT_OK && data != null) {
            switch (requestCode) {
                case 1000:
                    ...
                    ProfilPic1.setImageURI(filePath);
            ...
            if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
                ...
                ProfilPic1.setImageBitmap(imageBitmap);
                filePath = data.getData();
                ProfilPic1.setImageURI(filePath);
                // bytearrayoutputstream = null;
                //imgPath = getResizedBitmap(uploadimage);
