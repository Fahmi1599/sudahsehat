    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
                Toast.makeText(
                        com.example.skripsiact.CameraActivity.this,
...
//        }
    ...
    protected void setFragment() {
        ...
        if (useCamera2API) {
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    com.example.skripsiact.CameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
            ...
            com.example.skripsiact.LegacyCameraConnectionFragment frag = new com.example.skripsiact.LegacyCameraConnectionFragment(this,
                    getLayoutId(),
